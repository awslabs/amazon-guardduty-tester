...
torify awscurl --access_key=$AWS_ACCESS_KEY_ID --secret_key $AWS_SECRET_ACCESS_KEY --session_token $AWS_SESSION_TOKEN --region $REGION --service s3 https://$S3_BUCKET_NAME.s3.amazonaws.com